...
tmux send-keys -tdjangodash:0 'cd ~/Code/Python/djangodash/; . env/bin/activate; clear' C-m
tmux send-keys -tdjangodash:0 './manage.py runserver'
tmux send-keys -tdjangodash:1 'cd ~/Code/Python/djangodash/; clear' C-m
tmux send-keys -tdjangodash:2 'cd ~/Code/Python/djangodash/; . env/bin/activate; clear' C-m
